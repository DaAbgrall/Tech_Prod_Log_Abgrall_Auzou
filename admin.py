...
def creationBD():
   ...
   # cur.execute("DROP TABLE IF EXISTS Equipement")
    ...
    #cur.execute("CREATE TABLE IF NOT EXISTS Installation(numero INT PRIMARY KEY, nom TEXT,adresse TEXT, code_postal TEXT, ville TEXT, latitude DECIMAL, longitude DECIMAL)")
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS Equipement_Activite(numero_equipement INT , numero_activite INT, FOREIGN KEY(numero_equipement) REFERENCES Equipement(numero), FOREIGN KEY(numero_activite) REFERENCES Activite(numero) PRIMARY KEY(numero_equipement, numero_activite) )")    
