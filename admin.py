...
def creationBD():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS Installation(numero INT PRIMARY KEY, nom TEXT,adresse TEXT, code_postale TEXT, ville TEXT, latitude DECIMAL, logitude DECIMAL)")
